# Program to reorder XML containers alphabetically by their name sub-container "SHORT-NAME"
...
## Batch file is found in the exported folder
   batch file provided will run all three test cases or you can use
   `` java -jar exported/XMLParser [filename] ``
   
## Exceptions
- NotValidAutosarFileException: This exception is thrown when the input file does not have the .arxml extension.
- EmptyAutosarFileException: This exception is thrown when the input fil
